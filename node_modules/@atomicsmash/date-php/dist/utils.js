export function escapeAllCharacters(string) {
 ...
 */
export function replaceAllUnescaped(string, searchValue, replaceValue) {
    let newString = "";
    let index = 0;
    ...
    for (let stringPiece of splitString) {
        ...
        if (lastIndex === -1) {
            ...
            newString = `${newString}${stringPiece}${index > 0 ? "\\\\" : ""}${tempString}`;
        }
        index++;
    }
    return newString;
 ...
 */
export function searchFirstUnescaped(string, searchValue) {
