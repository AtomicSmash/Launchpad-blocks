...
.custom-multiple-select-list-item-label {
	flex: 1;
	text-align: left;
}`}}),a("section",{className:`custom-multiple-select-list${t!==void 0&&t!==""?` ${t}`:""}`,children:e.map(l=>o({listItem:l,buttonProps:{type:"button",className:`custom-multiple-select-list-item${l.isSelected?" is-selected":""}`}}))})]})}function fe(e){return e.indexOf("data:image/svg+xml,")===0}function ve(e){return e.indexOf("https://")===0||e.indexOf("http://")===0}function be(e){return e.indexOf("dashicons-")===0}function xe({iconString:e}){if(typeof e!="string")return null;if(e==="none"||e==="div")return a("div",{className:"menu-icon","aria-hidden":"true",children:a("br",{})});if(fe(e))return a("div",{className:"menu-icon svg",style:{backgroundImage:`url("${e}")`},"aria-hidden":"true",children:a("br",{})});if(ve(e))return a("img",{src:new URL(e).toString(),alt:""});if(be(e)){const t=e.replace("dashicons-","");return a(te,{icon:t,className:"menu-icon"})}throw new Error("The icon string provided is not any of the valid formats.")}const We={author:"Author Id",date:"Date",id:"Id",include:"Included posts by Id",modified:"Date Modified",parent:"Parent by Id",relevance:"Relevance",slug:"Post slug",include_slugs:"Included posts by slug",title:"Title"};function qe(){const[e,t,o,l]=T("color.palette.custom","color.palette.theme","color.palette.default","color.defaultPalette"),i={};if(l&&o&&o.length>0)for(const s of o)i[s.slug]={color:s.color,name:s.name};if(t&&t?.length>0)for(const s of t)i[s.slug]={color:s.color,name:s.name};if(e&&e?.length>0)for(const s of e)i[s.slug]={color:s.color,name:s.name};return{userPalette:e,themePalette:t,defaultPalette:o,allPalettes:i}}function Fe({colours:e,attributesDefinition:t,attributes:o,setAttributes:l}){return a(ne,{label:y("Custom colours","launchpad"),resetAll:i=>{if(i)for(const s of i)s()},children:a("div",{className:"color-block-support-panel__inner-wrapper",style:{gridColumn:"1 / -1"},children:e.map(i=>a(we,{colour:i,attributesDefinition:t,attributes:o,setAttributes:l},i.attributeName))})})}function we({colour:e,attributesDefinition:t,attributes:o,setAttributes:l}){const[i,s,r,u,d]=T("color.palette.custom","color.palette.theme","color.palette.default","color.defaultPalette","color.custom"),h=()=>t[e.attributeName]?.default!==o[e.attributeName],p=()=>{l({[e.attributeName]:t[e.attributeName]?.default??void 0})},v=V(null);return a(oe,{className:"block-editor-tools-panel-color-gradient-settings__item",style:{marginBlockStart:"0"},resetAllFilter:p,hasValue:h,onDeselect:p,label:e.label,isShownByDefault:!0,children:a(le,{className:"block-editor-tools-panel-color-gradient-settings__dropdown",popoverProps:{placement:"left-start",offset:36,shift:!0},renderToggle:({isOpen:c,onToggle:w})=>a(S,{children:a(L,{ref:v,__next40pxDefaultSize:!0,onClick:w,"aria-expanded":c,className:`block-editor-panel-color-gradient-settings__dropdown${c?" is-open":""}`,children:j("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center",gap:"8px"},children:[a(ie,{colorValue:o[e.attributeName]})," ",a("span",{children:e.label})]})})}),renderContent:()=>a(se,{paddingSize:"none",children:a("div",{className:"block-editor-panel-color-gradient-settings__dropdown-content",children:a("div",{className:"block-editor-color-gradient-control__panel",children:a(re,{colors:[...i&&i?.length>0?[{name:"User",colors:i}]:[],...s&&s?.length>0?[{name:"Theme",colors:s}]:[],...u&&r&&r.length>0?[{name:"Default",colors:r}]:[]],value:o[e.attributeName],onChange:c=>{l({[e.attributeName]:c})},disableCustomColors:!d})})})})})},e.attributeName)}function Ue({ratioValue:e,ratioOnChange:t,imageFitValue:o,imageFitOnChange:l}){const[i,s,r]=T("dimensions.aspectRatios.default","dimensions.aspectRatios.theme","dimensions.defaultAspectRatios"),u=s?.map(({name:c,ratio:w})=>({label:c,value:w}))??[],d=i?.map(({name:c,ratio:w})=>({label:c,value:w}))??[],h=[{label:D("Original","Aspect ratio option for dimensions control","launchpad-blocks"),value:"auto"},...r?d:[],...u||[],{label:D("Custom","Aspect ratio option for dimensions control","launchpad-blocks"),value:"custom"}],[p,v]=he(h.map(c=>c.value).includes(e)?e:"custom");return j(S,{children:[a(ae,{__nextHasNoMarginBottom:!0,__next40pxDefaultSize:!0,label:y("Aspect ratio","launchpad-blocks"),options:h,value:p,onChange:c=>{v(c),c!=="custom"&&t(c)}}),p==="custom"?a(ce,{__next40pxDefaultSize:!0,__nextHasNoMarginBottom:!0,label:y("Custom aspect ratio","launchpad-blocks"),help:y("Please enter a custom aspect ratio in the format `width/height`."),onChange:t,value:e}):null,e!=="auto"&&l!==void 0?j(de,{__next40pxDefaultSize:!0,__nextHasNoMarginBottom:!0,isBlock:!0,label:"Image fit",help:y("If your image doesn't match the selected aspect ratio, should we make the image `cover` the whole area (cutting off parts on the edge) or should we `contain` it (show the whole image in its correct aspect ratio, within a box of the aspect ratio you selected).","launchpad-blocks"),onChange:c=>{typeof c=="string"&&["contain","cover"].includes(c)&&l(c)},value:o,children:[a(R,{label:"Cover",value:"cover"}),a(R,{label:"Contain",value:"contain"})]}):null]})}const ke=(e,t,o,l)=>{const{getBlocksByName:i,getBlockAttributes:s,getBlockParentsByBlockName:r}=(0,W.select)(g.store);return i(l).some(d=>{if(r(d,"core/template-part",!0).length)return!1;const{[o]:h}=s(d);return e!==d&&t===h})};function _e(e,t,o,l,i){const{[t]:s}=e,r=(0,k.useCallback)(d=>ke(o,d,t,i),[o,t,i]);return(0,k.useEffect)(()=>{if(s===""){const d=o.slice(0,o.indexOf("-"));l({[t]:d})}if(r(s)){const d=o.slice(0,o.indexOf("-"));console.log(`Regenerated ${t} to make it unique. Old value: ${s}. New value: ${d}`),l({[t]:d})}},[s,o,l,r,t]),(0,k.useMemo)(()=>function({label:h,help:p,onValidChange:v,idAttribute:c}){const[w,N]=(0,k.useState)(c);return(0,n.jsx)(C.TextControl,{__next40pxDefaultSize:!0,__nextHasNoMarginBottom:!0,label:h,help:typeof p=="function"?p(!r(w)):p,value:w,onChange:m=>{N(m),r(m)||v(m)}})},[r])}function ye({levelOptions:e,selectedLevel:t,setSelectedHeadingLevel:o}){return(0,n.jsx)(C.ToolbarDropdownMenu,{label:(0,_.__)("Change title heading element","launchpad-blocks"),icon:O(t),controls:e.map(l=>{{const i=l===t;return{icon:O(l),title:Ce(l),isDisabled:i,onClick:()=>o(l)}}})})}function Ce(e){switch(e){case"h2":return(0,_.__)("Heading 2","launchpad-blocks");case"h3":return(0,_.__)("Heading 3","launchpad-blocks");case"h4":return(0,_.__)("Heading 4","launchpad-blocks");case"h5":return(0,_.__)("Heading 5","launchpad-blocks");case"h6":return(0,_.__)("Heading 6","launchpad-blocks");case"p":return(0,_.__)("Paragraph","launchpad-blocks")}}function O(e){switch(e){case"h2":return q;case"h3":return F;case"h4":return U;case"h5":return K;case"h6":return Z;case"p":return J}}function Ke(e){const{hasChildren:t}=P(o=>{const{getBlocks:l}=o(I);return{hasChildren:l(e).length>0}},[e]);return t}function Ze({clientId:e,blockInfo:t,variations:o,allowSkip:l}){const{replaceInnerBlocks:i,updateBlockAttributes:s}=pe(I);return j(ue,{icon:t.icon,label:t.name,instructions:"Please choose a variation to start with:",children:[a("ul",{className:"block-editor-block-variation-picker__variations",role:"list","aria-label":y("Block variations"),children:o.map(r=>j("li",{children:[a(L,{__next40pxDefaultSize:!0,variant:"tertiary",className:"block-editor-block-variation-picker__variation",icon:typeof r.icon=="string"?a(xe,{iconString:r.icon}):r.icon,iconSize:48,onClick:()=>{r.attributes&&s(e,r.attributes),r.innerBlocks&&i(e,ee(r.innerBlocks),!1)}}),a("span",{className:"block-editor-block-variation-picker__variation-label",children:r.title})]},r.name))}),l&&a("div",{className:"block-editor-block-variation-picker__skip",children:a(L,{__next40pxDefaultSize:!0,variant:"link",onClick:()=>{i(e,[],!1),s(e,{hasDismissedVariationsSelector:!0})},children:y("Skip")})})]})}function Je({imageId:e,className:t="",size:o="full"}){const l=P(s=>typeof e=="number"&&e>0?s(A).getEntityRecord?.("postType","attachment",e):void 0,[e]);return l?a(S,{children:a("img",{...(()=>{const s={src:l.source_url,className:`attachment-${o} size-${o} ${t}`,width:l.media_details.width,height:l.media_details.height,srcSet:""};return l.media_details?.sizes?.[o]&&(s.src=l.media_details.sizes[o].source_url,s.width=l.media_details.sizes[o].width,s.height=l.media_details.sizes[o].height),s.srcSet=Object.entries(l.media_details.sizes??{}).map(([r,u])=>`${u.source_url} ${u.width}w`).join(", "),s})(),alt:l.alt_text||""})}):null}function je(e){const t=[e.name];return e.attributes?t.push(e.attributes):t.push({}),e.innerBlocks?t.push(e.innerBlocks.map(o=>je(o))):t.push([]),t}function Xe(e){const t=V(null);return t.current=document.querySelector('iframe[name="editor-canvas"]')?.contentWindow?.document.querySelector(".is-root-container")??null,function(){setTimeout(()=>{if(t.current){const i=e()?.scrollHeight??0;if(i){const s=t.current.style;s.minHeight="",t.current.setAttribute("style",`${s.cssText}min-height: ${i}px !important`)}else t.current.style.minHeight=""}},1)}}var Be=x(1016),ze=x.n(Be);const Se=(0,n.jsx)(b.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",children:(0,n.jsx)(b.Path,{d:"M10 17.389H8.444A5.194 5.194 0 1 1 8.444 7H10v1.5H8.444a3.694 3.694 0 0 0 0 7.389H10v1.5ZM14 7h1.556a5.194 5.194 0 0 1 0 10.39H14v-1.5h1.556a3.694 3.694 0 0 0 0-7.39H14V7Zm-4.5 6h5v-1.5h-5V13Z"})}),Te={headerElement:{type:"string",enum:["h2","h3","h4","h5","h6","p"],default:"h2"},headerContent:{type:"string"},linkId:{type:"number"},linkKind:{type:"string"},linkType:{type:"string"},linkHref:{type:"string"},linkTarget:{type:"string",enum:["_self","_blank"],default:"_self"},navListContextLabelledBy:{type:"string",default:""}};function G({attributes:e,setAttributes:t,clientId:o}){const{linkHref:l,linkTarget:i,headerElement:s,headerContent:r,navListContextLabelledBy:u}=e,[d,h]=(0,k.useState)(!1),p=(0,g.useBlockProps)(),{children:v,...c}=(0,g.useInnerBlocksProps)(p,{template:[["launchpad-blocks/nav-list",{linkOrientation:"vertical"},[["launchpad-blocks/nav-menu-item"]]]],renderAppender:()=>null}),w=(0,k.useMemo)(()=>({url:l,opensInNewTab:i==="_blank",title:r}),[l,i,r]),N=_e(e,"navListContextLabelledBy",o,t,"launchpad-blocks/nav-links-group");return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(g.BlockControls,{children:[(0,n.jsx)(C.ToolbarGroup,{children:(0,n.jsx)(ye,{levelOptions:Te.headerElement.enum,selectedLevel:s,setSelectedHeadingLevel:m=>{t({headerElement:m})}})}),(0,n.jsxs)(C.ToolbarGroup,{children:[(0,n.jsx)(C.ToolbarButton,{icon:Se,label:"Edit",onClick:()=>h(!d)}),d?(0,n.jsx)(C.Popover,{position:"bottom",noArrow:!1,shift:!0,offset:10,children:(0,n.jsx)(g.LinkControl,{value:w,showInitialSuggestions:!0,onChange:m=>{t({linkId:m?.id,linkKind:m?.kind,linkType:m?.type,linkHref:m?.url,linkTarget:m?.opensInNewTab?"_blank":"_self",headerContent:m?.title}),h(!1)},onRemove:()=>{t({linkId:void 0,linkKind:void 0,linkType:void 0,linkHref:void 0})}},`${o}-link-edit`)}):null]})]}),(0,n.jsx)(g.InspectorAdvancedControls,{children:(0,n.jsx)(N,{label:"Unique Nav list identifier",help:m=>(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("span",{children:"This is used to differentiate the nav link groups from each other for accessibility. Must be unique on a page."}),m?null:(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("br",{}),(0,n.jsxs)("span",{style:{fontWeight:"bold",color:"red"},children:["This value is used by another nav links group on the page. Using this value: ",u," "]})]})]}),onValidChange:m=>{t({navListContextLabelledBy:m})},idAttribute:u})}),(0,n.jsxs)("div",{...c,children:[(0,n.jsx)(g.RichText,{tagName:s,value:r,onChange:m=>{t({headerContent:m})},allowedFormats:["core/bold","core/italic"],placeholder:"Add a title for this nav links group...",className:`nav-links-group-heading is-style-reset${l?" hyperlink":""}`}),v]})]})}G.displayName="NavLinksGroupEdit";function Le({hasInnerBlocks:e}){return e?He:Pe}function Pe(){return null}function He(){return(0,n.jsx)(g.InnerBlocks.Content,{})}const Ye={"launchpad-blocks/navListContextLabelledBy":"navListContextLabelledBy"},et=null;(0,f.registerBlockType)(ze().name,{icon:(0,n.jsx)(Y,{iconName:"tabs"}),edit:G,save:Le({hasInnerBlocks:!0})}),me()})(),z})());
