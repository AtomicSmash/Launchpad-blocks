...
.custom-multiple-select-list-item-label {
	flex: 1;
	text-align: left;
}`}}),jsx("section",{className:`custom-multiple-select-list${t!==void 0&&t!==""?` ${t}`:""}`,children:e.map(o=>n({listItem:o,buttonProps:{type:"button",className:`custom-multiple-select-list-item${o.isSelected?" is-selected":""}`}}))})]})}function L(e){return e.indexOf("data:image/svg+xml;")===0}function O(e){return e.indexOf("https://")===0||e.indexOf("http://")===0}function H(e){return e.indexOf("dashicons-")===0}function E({iconString:e}){if(typeof e!="string")return null;if(e==="none"||e==="div")return jsx("div",{className:"menu-icon","aria-hidden":"true",children:jsx("br",{})});if(L(e))return jsx("div",{className:"menu-icon svg",style:{backgroundImage:`url('${e}')`},"aria-hidden":"true",children:jsx("br",{})});if(O(e))return jsx("img",{src:new URL(e).toString(),alt:""});if(H(e)){const t=e.replace("dashicons-","");return jsx(DashIcon,{icon:t,className:"menu-icon"})}throw new Error("The icon string provided is not any of the valid formats.")}const me={author:"Author Id",date:"Date",id:"Id",include:"Included posts by Id",modified:"Date Modified",parent:"Parent by Id",relevance:"Relevance",slug:"Post slug",include_slugs:"Included posts by slug",title:"Title"};function pe(){const[e,t,n,o]=useSettings("color.palette.custom","color.palette.theme","color.palette.default","color.defaultPalette"),s={};if(o&&n&&n.length>0)for(const i of n)s[i.slug]={color:i.color,name:i.name};if(t&&t?.length>0)for(const i of t)s[i.slug]={color:i.color,name:i.name};if(e&&e?.length>0)for(const i of e)s[i.slug]={color:i.color,name:i.name};return{userPalette:e,themePalette:t,defaultPalette:n,allPalettes:s}}function he({colours:e,attributesDefinition:t,attributes:n,setAttributes:o}){return jsx(ToolsPanel,{label:__("Custom colours","launchpad"),resetAll:s=>{if(s)for(const i of s)i()},children:jsx("div",{className:"color-block-support-panel__inner-wrapper",style:{gridColumn:"1 / -1"},children:e.map(s=>jsx(G,{colour:s,attributesDefinition:t,attributes:n,setAttributes:o},s.attributeName))})})}function G({colour:e,attributesDefinition:t,attributes:n,setAttributes:o}){const[s,i,r,c,u]=useSettings("color.palette.custom","color.palette.theme","color.palette.default","color.defaultPalette","color.custom"),m=()=>t[e.attributeName]?.default!==n[e.attributeName],d=()=>{o({[e.attributeName]:t[e.attributeName]?.default??void 0})},p=useRef(null);return jsx(ToolsPanelItem,{className:"block-editor-tools-panel-color-gradient-settings__item",style:{marginBlockStart:"0"},resetAllFilter:d,hasValue:m,onDeselect:d,label:e.label,isShownByDefault:!0,children:jsx(Dropdown,{className:"block-editor-tools-panel-color-gradient-settings__dropdown",popoverProps:{placement:"left-start",offset:36,shift:!0},renderToggle:({isOpen:a,onToggle:x})=>jsx(Fragment,{children:jsx(Button,{ref:p,__next40pxDefaultSize:!0,onClick:x,"aria-expanded":a,className:`block-editor-panel-color-gradient-settings__dropdown${a?" is-open":""}`,children:jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center",gap:"8px"},children:[jsx(ColorIndicator,{colorValue:n[e.attributeName]})," ",jsx("span",{children:e.label})]})})}),renderContent:()=>jsx(DropdownContentWrapper,{paddingSize:"none",children:jsx("div",{className:"block-editor-panel-color-gradient-settings__dropdown-content",children:jsx("div",{className:"block-editor-color-gradient-control__panel",children:jsx(ColorPalette,{colors:[...s&&s?.length>0?[{name:"User",colors:s}]:[],...i&&i?.length>0?[{name:"Theme",colors:i}]:[],...c&&r&&r.length>0?[{name:"Default",colors:r}]:[]],value:n[e.attributeName],onChange:a=>{o({[e.attributeName]:a})},disableCustomColors:!u})})})})})},e.attributeName)}function fe({ratioValue:e,ratioOnChange:t,imageFitValue:n,imageFitOnChange:o}){const[s,i,r]=useSettings("dimensions.aspectRatios.default","dimensions.aspectRatios.theme","dimensions.defaultAspectRatios"),c=i?.map(({name:a,ratio:x})=>({label:a,value:x}))??[],u=s?.map(({name:a,ratio:x})=>({label:a,value:x}))??[],m=[{label:_x("Original","Aspect ratio option for dimensions control","launchpad-blocks"),value:"auto"},...r?u:[],...c||[],{label:_x("Custom","Aspect ratio option for dimensions control","launchpad-blocks"),value:"custom"}],[d,p]=useState(m.map(a=>a.value).includes(e)?e:"custom");return jsxs(Fragment,{children:[jsx(SelectControl,{__nextHasNoMarginBottom:!0,__next40pxDefaultSize:!0,label:__("Aspect ratio","launchpad-blocks"),options:m,value:d,onChange:a=>{p(a),a!=="custom"&&t(a)}}),d==="custom"?jsx(TextControl,{__next40pxDefaultSize:!0,__nextHasNoMarginBottom:!0,label:__("Custom aspect ratio","launchpad-blocks"),help:__("Please enter a custom aspect ratio in the format `width/height`."),onChange:t,value:e}):null,e!=="auto"&&o!==void 0?jsxs(ToggleGroupControl,{__next40pxDefaultSize:!0,__nextHasNoMarginBottom:!0,isBlock:!0,label:"Image fit",help:__("If your image doesn't match the selected aspect ratio, should we make the image `cover` the whole area (cutting off parts on the edge) or should we `contain` it (show the whole image in its correct aspect ratio, within a box of the aspect ratio you selected).","launchpad-blocks"),onChange:a=>{typeof a=="string"&&["contain","cover"].includes(a)&&o(a)},value:n,children:[jsx(ToggleGroupControlOption,{label:"Cover",value:"cover"}),jsx(ToggleGroupControlOption,{label:"Contain",value:"contain"})]}):null]})}const F=(e,t,n,o)=>{const{getBlocksByName:s,getBlockAttributes:i,getBlockParentsByBlockName:r}=select(blockEditorStore);return s(o).some(u=>{if(r(u,"core/template-part",!0).length)return!1;const{[n]:m}=i(u);return e!==u&&t===m})};function ge(e,t,n,o,s){const{[t]:i}=e,r=useCallback(u=>F(n,u,t,s),[n,t,s]);return useEffect(()=>{if(i===""){const u=n.slice(0,n.indexOf("-"));o({[t]:u})}if(r(i)){const u=n.slice(0,n.indexOf("-"));console.log(`Regenerated ${t} to make it unique. Old value: ${i}. New value: ${u}`),o({[t]:u})}},[i,n,o,r,t]),useMemo(()=>function({label:m,help:d,onValidChange:p,idAttribute:a}){const[x,C]=useState(a);return jsx(TextControl,{__next40pxDefaultSize:!0,__nextHasNoMarginBottom:!0,label:m,help:typeof d=="function"?d(!r(x)):d,value:x,onChange:f=>{C(f),r(f)||p(f)}})},[r])}function be({levelOptions:e,selectedLevel:t,setSelectedHeadingLevel:n}){return jsx(ToolbarDropdownMenu,{label:__("Change title heading element","launchpad-blocks"),icon:B(t),controls:e.map(o=>{{const s=o===t;return{icon:B(o),title:U(o),isDisabled:s,onClick:()=>n(o)}}})})}function U(e){switch(e){case"h2":return __("Heading 2","launchpad-blocks");case"h3":return __("Heading 3","launchpad-blocks");case"h4":return __("Heading 4","launchpad-blocks");case"h5":return __("Heading 5","launchpad-blocks");case"h6":return __("Heading 6","launchpad-blocks");case"p":return __("Paragraph","launchpad-blocks")}}function B(e){switch(e){case"h2":return headingLevel2;case"h3":return headingLevel3;case"h4":return headingLevel4;case"h5":return headingLevel5;case"h6":return headingLevel6;case"p":return paragraph}}function xe(e){const{hasChildren:t}=useSelect(n=>{const{getBlocks:o}=n(blockEditorStore);return{hasChildren:o(e).length>0}},[e]);return t}function ve({clientId:e,blockInfo:t,variations:n,allowSkip:o}){const{replaceInnerBlocks:s,updateBlockAttributes:i}=useDispatch(blockEditorStore);return jsxs(Placeholder,{icon:t.icon,label:t.name,instructions:"Please choose a variation to start with:",children:[jsx("ul",{className:"block-editor-block-variation-picker__variations",role:"list","aria-label":__("Block variations"),children:n.map(r=>jsxs("li",{children:[jsx(Button,{__next40pxDefaultSize:!0,variant:"tertiary",className:"block-editor-block-variation-picker__variation",icon:typeof r.icon=="string"?jsx(E,{iconString:r.icon}):r.icon,iconSize:48,onClick:()=>{r.attributes&&i(e,r.attributes),r.innerBlocks&&s(e,createBlocksFromInnerBlocksTemplate(r.innerBlocks),!1)}}),jsx("span",{className:"block-editor-block-variation-picker__variation-label",children:r.title})]},r.name))}),o&&jsx("div",{className:"block-editor-block-variation-picker__skip",children:jsx(Button,{__next40pxDefaultSize:!0,variant:"link",onClick:()=>{s(e,[],!1),i(e,{hasDismissedVariationsSelector:!0})},children:__("Skip")})})]})}function _e({imageId:e,className:t="",size:n="full"}){const o=useSelect(i=>typeof e=="number"&&e>0?i(coreStore).getEntityRecord?.("postType","attachment",e):void 0,[e]);if(!o)return null;const s=()=>{const i={src:o.source_url,className:`attachment-${n} size-${n} ${t}`,width:o.media_details.width,height:o.media_details.height,srcSet:""};return o.media_details?.sizes?.[n]&&(i.src=o.media_details.sizes[n].source_url,i.width=o.media_details.sizes[n].width,i.height=o.media_details.sizes[n].height),i.srcSet=Object.entries(o.media_details.sizes??{}).map(([r,c])=>`${c.source_url} ${c.width}w`).join(", "),i};return jsx(Fragment,{children:jsx("img",{...s(),alt:o.alt_text||""})})}function V(e){const t=[e.name];return e.attributes?t.push(e.attributes):t.push({}),e.innerBlocks?t.push(e.innerBlocks.map(n=>V(n))):t.push([]),t}function we(e){const t=useRef(null);return t.current=document.querySelector('iframe[name="editor-canvas"]')?.contentWindow?.document.querySelector(".is-root-container")??null,function(){setTimeout(()=>{if(t.current){const s=e()?.scrollHeight??0;if(s){const i=t.current.style;i.minHeight="",t.current.setAttribute("style",`${i.cssText}min-height: ${s}px !important`)}else t.current.style.minHeight=""}},1)}}var W=g(697),q=g.n(W);const J=window.wp.richText,K=window.wp.hooks,z=window.wp.element;function X({icon:e,size:t=24,...n},o){return(0,z.cloneElement)(e,{width:t,height:t,...n,ref:o})}const Z=(0,z.forwardRef)(X),y=window.wp.primitives,Q=(0,l.jsx)(y.SVG,{viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:(0,l.jsx)(y.Path,{d:"M6.5 12.4L12 8l5.5 4.4-.9 1.2L12 10l-4.5 3.6-1-1.2z"})}),Y=(0,l.jsx)(y.SVG,{viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:(0,l.jsx)(y.Path,{d:"M17.5 11.6L12 16l-5.5-4.4.9-1.2L12 14l4.5-3.6 1 1.2z"})}),ee={"accordion-arrow":{title:"Accordion arrow"},"accordion-group":{title:"Accordion group"},accordion:{title:"Accordion"},"back-arrow":{title:"Back Arrow"},"banner-zone":{title:"Banner zone"},"break-image-out":{title:"Break image out of container"},"button-with-icon":{title:"Button with Icon"},carousel:{title:"Carousel"},"carousel-navigation-arrows":{title:"Carousel navigation arrows"},"carousel-thumbnails":{title:"Carousel thumbnails"},"carousel-slides":{title:"Carousel slides"},"carousel-with-thumbnails":{title:"Carousel with thumbnails"},"gallery-carousel":{title:"Gallery carousel"},"gallery-carousel-lightbox":{title:"Lightbox"},"heading-with-icon":{title:"Heading with icon"},icon:{title:"Icon"},information:{title:"Information"},list:{title:"List"},"list-item":{title:"List item"},"media-and-text-heading-and-text":{title:"Heading and text"},"media-and-text-heading-text-buttons":{title:"Heading, text and button"},"media-and-text-intro-heading-and-text":{title:"Intro, heading and text"},"media-and-text-intro-heading-text-buttons":{title:"Intro, heading, text and button"},"media-and-text-just-text":{title:"Text"},navigation:{title:"Navigation"},"nav-list":{title:"Nav list"},"nav-menu-item":{title:"Nav menu item"},"nav-sub-menu":{title:"Nav sub menu"},tabs:{title:"Tabs"},"tab-list":{title:"Tab list"},"tab-panel-group":{title:"Tab panel group"},"tab-panel":{title:"Tab panel"},"menu-open-icon":{title:"Menu Open Icon"},"menu-close-icon":{title:"Menu Close Icon"},"manual-post-select":{title:"Manual post select"},plus:{title:"Plus",makeAvailableToUser:!0},minus:{title:"Minus",makeAvailableToUser:!0},"logo-banner":{title:"Logo banner"},"vertical-tabs":{title:"Vertical tabs"},"carousel-dots":{title:"Carousel dots"},"carousel-slide-count":{title:"Carousel slide count"},cta:{title:"CTA"},"numbered-columns":{title:"Numbered columns"},"section-with-title":{title:"Section"},"chevron-down":{title:(0,w.__)("Chevron down","launchpad-blocks"),makeAvailableToUser:!0},"chevron-left":{title:(0,w.__)("Chevron left","launchpad-blocks"),makeAvailableToUser:!0},"chevron-right":{title:(0,w.__)("Chevron right","launchpad-blocks"),makeAvailableToUser:!0},"chevron-up":{title:(0,w.__)("Chevron up","launchpad-blocks"),makeAvailableToUser:!0}},te={"launchpad-blocks":{name:"Launchpad blocks",renderIcon:(e,t)=>(0,l.jsx)(T,{iconName:e,isEditorMode:!0,...t}),availableIcons:Object.fromEntries(Object.entries(ee).filter(([e,t])=>t.makeAvailableToUser===!0))}};function I(){return(0,K.applyFilters)("launchpadBlocks.icons",{...te})}function ne({iconSelectHeader:e="Icon Select",dataOnSelectedIcon:t,onIconSelect:n,onReset:o}){const s=I(),[i,r]=(0,_.useState)("");return(0,l.jsxs)(v.Panel,{children:[(0,l.jsxs)(v.PanelHeader,{children:[e," ",o?(0,l.jsx)(v.Button,{variant:"secondary",isDestructive:!0,onClick:()=>{o()},size:"small",children:"Reset"}):null]}),(0,l.jsxs)(v.PanelBody,{children:[(0,l.jsx)(v.SearchControl,{__nextHasNoMarginBottom:!0,label:"Search icons",value:i,onChange:c=>{r(c)}}),(0,l.jsx)("div",{children:Object.entries(s).map(([c,u])=>{if(Object.keys(u.availableIcons).length===0)return null;const m=Object.entries(u.availableIcons).filter(([d,{title:p}])=>!!(d.includes(i)||p.includes(i)));return(0,l.jsx)(oe,{name:u.name,iconCount:m.length,children:(0,l.jsx)("div",{className:`icon-select ${c}-icon-select`,children:m.map(([d,{title:p}])=>{const a=t.iconName===d&&t.library===c;return(0,l.jsx)("button",{className:`icon-select-icon ${c}-icon-select-icon ${c}-icon-select-icon-${d}${a?" is-selected":""}`,onClick:()=>{n({iconName:d,library:c})},title:p,children:u.renderIcon(d)},d)})})},c)})})]})]})}function oe({name:e,iconCount:t,children:n}){const[o,s]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{t===0&&o&&s(!1)},[o,t]),(0,l.jsxs)("div",{className:"icon-select-group-accordion",children:[(0,l.jsx)("h3",{className:"icon-select-group-accordion-header",children:(0,l.jsxs)(v.Button,{type:"button","aria-expanded":o,onClick:()=>{t>0&&s(!o)},disabled:t===0,className:"icon-select-group-accordion-header-button",children:[(0,l.jsxs)("span",{className:"icon-select-group-accordion-title",children:[e," icons"]}),(0,l.jsx)("span",{className:"icon-select-group-accordion-icon-count",children:t}),(0,l.jsx)(Z,{className:"icon-select-group-accordion-arrow",icon:o?Q:Y})]})}),o?n:null]})}function P({attributes:e,context:t,setAttributes:n,mergeBlocks:o,onReplace:s,onRemove:i}){const{textContent:r,iconName:c,library:u}=e,m=t["launchpad-blocks/fancyListType"]==="ul"&&t["launchpad-blocks/fancyListMarkerType"]==="icon",d=m&&c&&u,p=(0,b.useBlockProps)({className:`${d?"has-icon":""}`}),a=I(),x=(0,_.useRef)(null),C=(0,$.useSelect)(f=>f(J.store).getFormatTypes(),[]).map(f=>f.name);return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(b.InspectorControls,{children:m?(0,l.jsx)(ne,{dataOnSelectedIcon:{iconName:c,library:u},onIconSelect:f=>{n({iconName:f.iconName,library:f.library})},onReset:()=>{n({iconName:void 0,library:void 0})}}):null}),(0,l.jsxs)("li",{...p,children:[d?a[u]?.renderIcon(c,{className:"list-item-icon"}):null,(0,l.jsx)(b.RichText,{identifier:"textContent",ref:x,tagName:"span",onChange:f=>{n({textContent:f})},onMerge:o,onReplace:s,onRemove:i,value:r,placeholder:(0,w.__)("Write your list item content...","launchpad-blocks"),allowedFormats:[...C.filter(f=>f!=="core/footnote"&&f!=="core/image")]})]})]})}P.displayName="FancyListItemEdit";function se({hasInnerBlocks:e}){return e?le:ie}function ie(){return null}function le(){return(0,l.jsx)(b.InnerBlocks.Content,{})}(0,h.registerBlockType)(q().name,{icon:(0,l.jsx)(T,{iconName:"list-item"}),edit:P,save:se({hasInnerBlocks:!0}),merge:(e,t)=>({...e,textContent:(e.textContent??"")+(t.textContent??"")})}),R()})(),j})());
